...
export const WORKOUT_PHRASES = [
  ...
  'Каждая тренировка — инвестиция в здоровье 💪',
  'Тело достигнет того, чего верит ум 🧠',
  'Даже 15 минут активности лучше, чем ничего ⏱️',
  'Сила растёт там, где заканчивается зона комфорта 🔥',
  'Последняя тренировка всегда самой тяжёлая — просто начни 🚀',
  'Прогресс, а не идеальность — вот что считается 📈',
]
