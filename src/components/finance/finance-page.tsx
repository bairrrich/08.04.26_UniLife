...
export default function FinancePage() {
  ...
  const spendingInsights = useMemo(() => {
    ...
    // Top 3 categories (already computed from stats.byCategory)
    const top3 = (stats?.byCategory || [])
      .slice()
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="flex items-center gap-3 rounded-xl bg-muted/40 p-3.5">
                ...
                <div>
                  ...
                  <p className="text-base font-bold tabular-nums">{formatMoney(spendingInsights.avgDaily)}</p>
              ...
              <div className="flex items-center gap-3 rounded-xl bg-muted/40 p-3.5">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-base font-bold tabular-nums">{formatMoney(spendingInsights.biggestExpense.amount)}</p>
